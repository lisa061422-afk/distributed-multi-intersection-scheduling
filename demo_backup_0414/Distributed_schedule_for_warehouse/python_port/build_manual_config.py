...
Usage (from warehouse root or python_port/):
    python python_port/build_manual_config.py
"""
...
# (e.g. `python python_port/build_manual_config.py` from the repo root).
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))

from python_port import topology as _topo
