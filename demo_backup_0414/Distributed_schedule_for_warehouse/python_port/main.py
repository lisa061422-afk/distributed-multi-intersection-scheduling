...
# ── 模式：选一个 ──
MODE = 'interactive'   # 'interactive' | 'random' | 'manual'
...
MANUAL_SPEC    = 'python_port/example_manual_topo.py'   # 仅 manual 模式
...
from python_port.topology import (manual_topology, random_topology,
                                    plot_topology)
