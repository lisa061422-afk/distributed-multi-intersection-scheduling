...
%
% This script can be run from any directory inside MATLAB.
...
CASE_NAME = 'manual_10r';
CASE_DIR  = fullfile(paths.batchDir, CASE_NAME);
ADMM_MAT  = fullfile(CASE_DIR, 'FourIntersection_ADMM_manual_10r.mat');
FCFS_MAT  = fullfile(CASE_DIR, 'FCFS_manual_10r.mat');
