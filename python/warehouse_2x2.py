"""
Warehouse 2x2 4-intersection topology (matches the traffic-demo HTML layout).
...
Run:
    Set MODE = 'manual' and MANUAL_SPEC = 'python/warehouse_2x2.py'
    in python/main.py, then run: python python/main.py
"""
